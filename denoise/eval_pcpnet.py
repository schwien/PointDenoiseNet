...
def parse_arguments():
    ...
    parser.add_argument('--modeldir', type=str, default='../models/pcp', help='model folder')
    ...
    parser.add_argument('--nrun', type=int, default=3, help='nrun')
    parser.add_argument('--shapename', type=str, default='54_{i}', help='shape to evaluate format : name{i}')
...
def get_meaned_displacements(dataset, moved_points, n_neighbours):
    ...
    nearest_neighbours = shp.kdtree.query(shp.pts, n_neighbours)[1]
