...
from pcpnet1 import ResMSPCPNet, ResPCPNet
...
def parse_arguments():
    ...
    parser.add_argument('--outdir', type=str, default='../models/pcp',
    ...
    parser.add_argument('--points_per_patch', type=int,
                        default=200, help='max. number of points per patch')# 50
